...
def main():
    tag_SARSA_pendulum = False  # SARSA on pendulum
    tag_Q_pendulum = True  # Q-learning on pendulum
    ...
    if tag_SARSA_pendulum:
        ...
        if tag_run_eps_alpha_grid:
            ...
            for eps in epsVec:
                ...
                logs.append(log)
            plot_learning_curve(logs, 'SARSA_vary_eps.png', 'pendulum', 'e')
    ...
    if tag_Q_pendulum:
        ...
        if tag_run_eps_alpha_grid:
            ...
            plot_learning_curve(logs, 'Q_vary_eps.png', 'pendulum', 'e')
            ...
            plot_learning_curve(logs, 'Q_vary_alp.png', 'pendulum', 'a')
